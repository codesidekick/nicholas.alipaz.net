$Id: README.txt,v 1.1.2.1 2010/11/02 23:18:52 nicholasalipaz Exp $
Description
-----------
...
4. Create a new context at admin/build/context and select 'Useragent string'
   to test it out.
...
5. (Optional) If you enabled the context_useragent_default module you will
   notice a number of new contexts available at admin/build/context.  View
